<?php
/**
 * Function to sanitize responsive range control
 */

if( ! function_exists( 'THEME_PREFIX_sanitize_responsive_range' ) ) :
    function THEME_PREFIX_sanitize_responsive_range( $range, $setting ) {
